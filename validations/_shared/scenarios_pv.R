...
# lever: radical cure, with primaquine and with tafenoquine, which differ in
# tafenoquine's longer liver-stage protection and its full blood-stage efficacy
# (1 against 0.948); the hypnozoite efficacy is the same.
